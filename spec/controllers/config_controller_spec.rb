describe ConfigController do
  ...
  context 'unauthenticated' do
    ...
    it 'should contain the correct properties' do
      expect(subject).to have_at_most(9).items
      %w(applicationLayer applicationVersion clientHostname googleAnalyticsId sentryUrl csrfToken csrfParam providedServices).each do |key|
