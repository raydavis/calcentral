  ...
  Rails.application.config.after_initialize do
    ...
    if Settings.edodb.adapter == 'h2'
      ...
      CREATE ALIAS TO_TIMESTAMP AS $$
        java.util.Date to_date(String value, String format) throws java.text.ParseException {
          // Convert Oracle timestamp format to Java SimpleDateFormat
          if (format.equals("YYYY-MM-DD HH24:MI:SS")) {
      ...
      CREATE TABLE SYSADM.BOA_ADVISEE_NOTE00_VW (
        EMPLID	VARCHAR2(11 CHAR),
        SAA_NOTE_ID	VARCHAR2(5 CHAR),
        SAA_SEQ_NBR	NUMBER(38),
        SCI_NOTE_PRIORITY	VARCHAR2(10 CHAR),
        SAA_NOTE_ITM_LONG	CLOB,
        SCC_ROW_ADD_OPRID	VARCHAR2(30 CHAR),
        SCC_ROW_ADD_DTTM	TIMESTAMP(6),
        SCC_ROW_UPD_OPRID	VARCHAR2(30 CHAR),
        SCC_ROW_UPD_DTTM	TIMESTAMP(6),
        SCI_APPT_ID	VARCHAR2(10 CHAR),
        SAA_NOTE_TYPE	VARCHAR2(10 CHAR),
        SAA_NOTE_SUBTYPE	VARCHAR2(10 CHAR),
        ADVISOR_ID	VARCHAR2(11 CHAR),
        SCI_TOPIC	VARCHAR2(30 CHAR),
        UC_ADV_TYP_DESC	VARCHAR2(30 CHAR),
        UC_ADV_SUBTYP_DESC	VARCHAR2(30 CHAR)
      );
      ...
      CREATE TABLE SYSADM.BOA_ADVISE_USERATTACHFILENAME00_VW (
        ...
        SAA_NOTE_ID	VARCHAR2(5 CHAR),
        SAA_SEQ_NBR	NUMBER(38),
        USERFILENAME	VARCHAR2(64 CHAR),
        ATTACHSYSFILENAME	VARCHAR2(128 CHAR)
      );
      ...
      CREATE TABLE SYSADM.BOA_STUDENT_ADVISOR_VW (
        ...
        CAMPUS_ID	VARCHAR2(16 CHAR),
        INSTITUTION	VARCHAR2(5 CHAR),
        ACADEMIC_CAREER	VARCHAR2(4 CHAR),
        ACADEMIC_PROGRAM	VARCHAR2(5 CHAR),
        ACADEMIC_PLAN	VARCHAR2(10 CHAR),
        ADVISOR_ROLE	VARCHAR2(4 CHAR),
        ADVISOR_ID	VARCHAR2(11 CHAR),
        ACADEMIC_CAREER_DESCR	VARCHAR2(30 CHAR),
        ACADEMIC_PROGRAM_DESCR	VARCHAR2(30 CHAR),
        ACADEMIC_PLAN_DESCR	VARCHAR2(30 CHAR),
        ADVISOR_ROLE_DESCR	VARCHAR2(30 CHAR)
      );
      ...
      CREATE TABLE SYSADM.BOA_INSTRUCTOR_ADVISOR_VW (
        ...
        CAMPUS_ID	VARCHAR2(16 CHAR),
        INSTITUTION	VARCHAR2(5 CHAR),
        INSTRUCTOR_ADISOR_NUMBER	NUMBER(38),
        ADVISOR_TYPE	VARCHAR2(4 CHAR),
        EFFECTIVE_DATE	DATE,
        EFFECTIVE_STATUS	VARCHAR2(1 CHAR),
        ACADEMIC_ORGANIZATION	VARCHAR2(10 CHAR),
        ADVISOR_FLAG	VARCHAR2(1 CHAR),
        INSTRUCTOR_TYPE	VARCHAR2(4 CHAR),
        ACADEMIC_CAREER	VARCHAR2(4 CHAR),
        ACADEMIC_PROGRAM	VARCHAR2(5 CHAR),
        ACADEMIC_PLAN	VARCHAR2(10 CHAR),
        ACADEMIC_SUB_PLAN	VARCHAR2(10 CHAR),
        ACADEMIC_CAREER_DESCR	VARCHAR2(30 CHAR),
        ACADEMIC_PROGRAM_DESCR	VARCHAR2(30 CHAR),
        ACADEMIC_PLAN_DESCR	VARCHAR2(30 CHAR),
        ACADEMIC_SUB_PLAN_DESCR	VARCHAR2(30 CHAR),
        ADVISOR_TYPE_DESCR	VARCHAR2(30 CHAR),
        INSTRUCTOR_TYPE_DESCR	VARCHAR2(30 CHAR)
      );
      ...
      CREATE TABLE SYSADM.BOA_ADV_NOTES_ACCESS_VW (
        ...
        CS_ID	VARCHAR2(11 CHAR),
        PERMISSION_LIST	VARCHAR2(30 CHAR),
        DISPLAY_ONLY	NUMBER(38),
        BAR_ITEM_NAME	VARCHAR2(30 CHAR),
        PANEL_ITEM_NAME	VARCHAR2(30 CHAR),
        NAME	VARCHAR2(30 CHAR),
        AUTH_ACTIONS	VARCHAR2(100 CHAR)
      );
      INSERT INTO SYSADM.BOA_ADV_NOTES_ACCESS_VW (USER_ID,CS_ID,PERMISSION_LIST,DISPLAY_ONLY,BAR_ITEM_NAME,PANEL_ITEM_NAME,NAME,AUTH_ACTIONS) VALUES ('123456','303123456','UC_CS_AA_CURRICULAR_ADVISOR',0,'SCI_NOTE_FLU','SCI_AA_ADVNOTE_FLU','Kool Keith','Add Update/Display Update/Display All Correction');
      INSERT INTO SYSADM.BOA_ADV_NOTES_ACCESS_VW (USER_ID,CS_ID,PERMISSION_LIST,DISPLAY_ONLY,BAR_ITEM_NAME,PANEL_ITEM_NAME,NAME,AUTH_ACTIONS) VALUES ('234567','303234567','UC_CS_AA_CO_CURRICULAR_ADVISOR',0,'SCI_NOTE_FLU','SCI_AA_ADVNOTE_FLU','Ced Gee','Add Update/Display Update/Display All Correction');
      INSERT INTO SYSADM.BOA_ADV_NOTES_ACCESS_VW (USER_ID,CS_ID,PERMISSION_LIST,DISPLAY_ONLY,BAR_ITEM_NAME,PANEL_ITEM_NAME,NAME,AUTH_ACTIONS) VALUES ('345678','303345678','UC_CS_AA_CURRICULAR_ADVISOR',0,'SCI_NOTE_FLU','SCI_AA_ADVNOTE_FLU','DJ Moe Love','Add Update/Display Update/Display All Correction');
