...
if [ "${APP_MODE}" == "calcentral" ] ; then
  ...
  verify_cs 'cs_fin_aid_award_compare' "${yml_features_cs_fin_aid_award_compare}" \
    "/UC_FA_AWARD_COMPARE_CURRNT.v1/get?EMPLID=${CAMPUS_SOLUTIONS_ID}&AID_YEAR=2018" \
    "/UC_FA_AWARD_COMPARE_PARMS.v1/get?EMPLID=${CAMPUS_SOLUTIONS_ID}&AID_YEAR=2018" \
    "/UC_FA_AWARD_COMPARE_PRIOR.v1/get?EMPLID=${CAMPUS_SOLUTIONS_ID}&AID_YEAR=2018"
